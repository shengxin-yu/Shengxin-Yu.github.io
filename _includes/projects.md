...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="periodical"><strong>Research Findings:</strong> Journals <p id="project_Journal_[1]-accepted">[1]-accepted</p><em><a href="https://shengxinyu.netlify.app/#Journal_[1]">[Link to publication]</a></em> and [2]-ongoing, Patents [1]- authorized and [2]-ongoing.</div>
    <div class="links">
